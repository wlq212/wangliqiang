...
.leftmenu{background:#EEF2FB;height:auto;margin:0 auto; width:170px;border:1px solid #73C2FF;}
...
<div class="leftmenu" style="width: 150px; height:688px ">
	<div class="lmenua" id="treePic1" onClick="javascript:ShowFLT(1)" style="width: 150px ">
	  <div align="left">房产信息</div>
	</div>
	<div id="LM1">
<div id="LMb1" class="pclist" style="width: 135px; height:70px ">
			<ul>
				<li><span onclick='checkTdBg(this);'><a href="listVillageServlet" target="I2">小区信息</li>
				<li><span onclick='checkTdBg(this);'><a href="listBuildingServlet" target="I2">楼栋信息</a></span></li> 
				<li><span onclick='checkTdBg(this);'><a href="listRoomServlet" target="I2">房间信息</a></span></li>
		  </ul>
	  </div>
	</div>
...
<div id="LMb2" class="pclist" style="width: 135px; height:130px ">
  <ul><li><span onclick='checkTdBg(this);'><a href="listStuffServlet" target="I2">基本信息</a></span></li> 
	    <li><span onclick='checkTdBg(this);'><a href="listContractServlet" target="I2">合同信息</a></span></li>
          <li><span onclick='checkTdBg(this);'><a href="listAssessServlet" target="I2">岗位考核</a></span></li>
          <li><span onclick='checkTdBg(this);'><a href="listTrainServlet" target="I2">在职培训</a></span></li>
          <li><span onclick='checkTdBg(this);'><a href="listLeaveServlet" target="I2">离职信息</a></span></li>
		  </ul>
	  </div>
	</div>
    
    <div class="lmenua" id="treePic3" onClick="javascript:ShowFLT(3)">
	  <div align="left">客户信息</div>
	</div>
	<div id="LM3">
<div id="LMb3" class="pclist" style="width: 135px; height:100px ">
  <ul><li><span onclick='checkTdBg(this);'><a href="listUseServlet" target="I2">个人信息</a></span></li> 
	    <li><span onclick='checkTdBg(this);'><a href="listBhouseServlet" target="I2">购租房信息</a></span></li>
          <li><span onclick='checkTdBg(this);'><a href="listRepairServlet" target="I2">维修信息</a></span></li>
          <li><span onclick='checkTdBg(this);'><a href="listDebtServlet" target="I2">欠费信息</a></span></li>
		  </ul>
	  </div>
	</div>
    
    
    <div class="lmenua" id="treePic4" onClick="javascript:ShowFLT(4)">
	  <div align="left">投诉建议</div>
	</div>
	<div id="LM4">
<div id="LMb4" class="pclist" style="width: 135px; height:30px ">
  <ul><li><span onclick='checkTdBg(this);'><a href="listComplaintServlet" target="I2">投诉信息</a></span></li> 
		  </ul>
	  </div>
	</div>
