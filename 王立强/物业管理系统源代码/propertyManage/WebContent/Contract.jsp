  ...
  %>
    ...
    <tr>
      ...
      <td width="324"><form id="content" name="content" method="post" action="">
        <label>
        <input type="text" name="content" id="content" size="60"value="<%=contract.getContent()%>"/>
        </label>
      </td>
      <td width="182"><div align="center">生效时间</div></td>
      <td width="325"><form id="begintime" name="begintime" method="post" action="">
        <label>
          <input type="text" name="begintime" id="begintime" value="<%=contract.getBegintime()%>"/>
          </label>
     </td>
    </tr>
    <tr>
      ...
      <td><form id="form5" name="form5" method="post" action="">
        <label>
          <input name="time" type="text" id="time" maxlength="100"value="<%=contract.getTime()%>" />
          </label>
      </td>
