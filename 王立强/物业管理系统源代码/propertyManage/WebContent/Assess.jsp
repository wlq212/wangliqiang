  ...
  %>
    ...
    <tr>
      ...
      <td colspan="3"><form id="form2" name="content" method="post" action="">
        <label>
        <input type="text" name="content" id="content" value="<%=assess.getContent()%>">
        </label>
      </form></td>
    </tr>
    <tr>
      ...
      <td width="225"><form id="form3" name="time" method="post" action="">
        <label>
        <input type="text" name="time" id="time" value="<%=assess.getTime()%>"/>
        </label>
      </form></td>
    ...
    <tr>
      ...
      <td><form id="form5" name="rank" method="post" action="">
        <label>
        <input type="text" name="rank" id="rank" value="<%=assess.getRank()%>"/>
        </label>
      </form></td>
      <td>
        <label></label>
