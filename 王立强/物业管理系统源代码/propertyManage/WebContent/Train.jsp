  ...
  %>
    ...
    <tr>
      ...
      <td><form id="form2" name="form2" method="post" action="">
        <label>
          <input type="text" name="content" id="content" value="<%=train.getContent()%>"/>
          </label>
      </td>
    </tr>
    <tr>
      ...
      <td width="324"><form id="content" name="content" method="post" action="">
        <label>
        <input type="text" name="time" id="time" value="<%=train.getTime()%>"/>
        </label>
      </td>
    ...
    <tr>
      ...
      <td><form id="form6" name="form6" method="post" action="">
        <label>
          <input type="text" name="behave" id="behave" value="<%=train.getBehave()%>" />
          </label>
      </td>
    </tr>
    <tr>
