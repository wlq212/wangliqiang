          ...
          <table width="790" border="2">
            ...
            <tr>
              ...
              <td><form id="form9" name="form9" method="post" action="">
                <label>
                  <input type="text" name="education" id="education" value="<%=staff.getEducation()%>" readOnly=true/>
                  </label>
             </td>
            </tr>
            <tr>
              ...
              <td><form id="form4" name="form4" method="post" action="">
                <label>
                  <input type="text" name="address" id="address"value="<%=staff.getAddress()%>" readOnly=true/>
                  </label>
             </td>
              <td><div align="center">邮箱</div></td>
              <td><input type="text" name="email" id="email"value="<%=staff.getEmail()%>" readOnly=true/></td>
            </tr>
            <tr>
              <td><div align="center">电话号码</div></td>
              <td><form id="form5" name="form5" method="post" action="">
                <label>
                  <input type="text" name="phone" id="phone"value="<%=staff.getPhone()%>" readOnly=true/>
                  </label>
             </td>
              <td><div align="center">政治面貌</div></td>
              <td><input type="text" name="status" id="status"value="<%=staff.getStatus()%>" readOnly=true/></td>
            </tr>
            <tr>
