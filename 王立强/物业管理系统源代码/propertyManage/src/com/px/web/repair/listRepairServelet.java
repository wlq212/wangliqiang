...
/**
 * Servlet implementation class listRepairServelet
 */
@WebServlet("/listRepairServlet")
public class listRepairServelet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public listRepairServelet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Repair> repairs = repairService.listAllRepair();
