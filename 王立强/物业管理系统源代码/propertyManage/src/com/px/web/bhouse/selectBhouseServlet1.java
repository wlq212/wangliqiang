 ...
 */
@WebServlet("/selectBhouseServlet1")
public class selectBhouseServlet1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public selectBhouseServlet1() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(bhouses!=null){
			...
			request.getRequestDispatcher("Bhouse.jsp").forward(request, response);
		}
		else{
